...
class NetworkQualityLog(models.Model):
    user          = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='network_logs', null=True, blank=True)
...
class CampusLocation(models.Model):
    user       = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='campus_location')
...
class UserInteraction(models.Model):
    ...
    resource         = models.ForeignKey('resources.Resource', on_delete=models.CASCADE, related_name='interactions', null=True, blank=True)
    event_type       = models.CharField(max_length=20, choices=EVENT_TYPES, db_index=True)
    session_id       = models.CharField(max_length=64, blank=True, db_index=True)
    time_on_resource = models.PositiveIntegerField(default=0)
    query_used       = models.CharField(max_length=255, blank=True)
    ...
    class Meta:
        ...
        indexes      = [models.Index(fields=['user', 'resource', 'event_type'])]
